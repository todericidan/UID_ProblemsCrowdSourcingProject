...
<div class="section white">
    <div class="row container">
        ...
        <div class="row">
            ...
            <div class="col">
                <a class="waves-effect waves-light btn grey lighten-3 btn-faded">Register here</a>
            </div>
...
<div class="parallax-container">
    <div class="parallax"><img src="${pageContext.request.contextPath}/resources/img/Picture2.jpg"></div>
</div>
